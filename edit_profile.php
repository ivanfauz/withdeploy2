...
<head>
    ...
    <link rel="icon" type="img/user/logo.png" href="img/logo.png">
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            <li><a href="barang_lelang.php"><span class="short-vga">Home</span><span class="full-text"> Home</span></a>
            </li>
            <li><a href="vga_second.html"><span class="short-vga">Scd</span><span class="full-text"> Second</span></a>
            </li>
            <li><a href="vga_ex_mining.html"><span class="short-vga">Ex</span><span class="full-text">
                        Ex-Mining</span></a></li>
