...
<body>
   ...
   <ul>
        <li><a href="vga_second_admin.html"><span class="short-vga">Scd</span><span class="full-text"> Second</span></a></li>
        <li><a href="vga_ex_mining_admin.html"><span class="short-vga">Ex</span><span class="full-text"> Ex-Mining</span></a></li>
...
<div class="user-profile">
    <img src="img/admin.png" alt="Profile" id="profile-icon">
    <div class="user-menu" id="user-menu">
        <a href="edit_profile_admin.php">Edit Profil</a> <!-- Pengalihan ke halaman edit_profile.php -->
